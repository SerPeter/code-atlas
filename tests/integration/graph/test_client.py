...
def _index_env(settings: AtlasSettings, *, dimension: int) -> dict[str, str]:
    ...
    return {
        ...
        "ATLAS_BACKEND__GRAPH__MEMGRAPH__PORT": str(settings.memgraph.port),
        "ATLAS_BACKEND__GRAPH__MEMGRAPH__USERNAME": "",
        "ATLAS_BACKEND__GRAPH__MEMGRAPH__PASSWORD": "",
        "ATLAS_BACKEND__QUEUE__VALKEY__HOST": settings.redis.host,
        "ATLAS_BACKEND__QUEUE__VALKEY__PORT": str(settings.redis.port),
        "ATLAS_BACKEND__QUEUE__VALKEY__DB": "0",
        "ATLAS_BACKEND__QUEUE__VALKEY__PASSWORD": "",
        "ATLAS_BACKEND__QUEUE__VALKEY__STREAM_PREFIX": settings.redis.stream_prefix,
